...
exports.createPOIView = exports.createTimeOfDayFunction = exports.insertIntoAccidentsLocation = exports.createAccidentsLocationTable = exports.insertRowQuery = exports.createTableQuery = void 0;
exports.createTableQuery = "CREATE TABLE ?? (\
...
exports.insertRowQuery = "INSERT INTO ?? (source, tmc, severity, start_time, end_time, \
...
exports.createAccidentsLocationTable = "CREATE TABLE accidents_location (\
  id BIGINT,\
  start_time DATETIME,\
  end_time DATETIME,\
  severity INT,\
  ...
  city TEXT,\
  state TEXT)";
exports.insertIntoAccidentsLocation = "INSERT INTO accidents_location (id, start_time, end_time, severity, start_lat, start_lng, number,\
  street, side, city, state) SELECT id, start_time, end_time, severity, start_lat, start_lng, number, street, side, city, state FROM ??";
exports.createTimeOfDayFunction = "CREATE\
...
";
exports.createPOIView = "create view converted_points_of_interest as \
